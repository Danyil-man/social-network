...
const NewPostModal: FC<PropsModal> = ({ closeModal, postItem,
    ...
    let postrequestData = postItem.photos_attributes.map(data => data.image.metadata)
    const handleChange = ({ postrequestData, remove }: any, status: any) => {
