...
interface FormProps {
    ...
    questiontag: string;
    directtag: string;
    hregDirection: string;
}

const Form: FC<FormProps> = ({title, handleClick, questiontag, directtag, hregDirection}) => {
            ...
            <form className={form.form__content}>
                ...
                <div className={form.form__item}>
                  ...
                  <div className={form.questionBlock}>
                    ...
                    <Link to={directtag}>{title}</Link>
                </div>
            <div className={form.buttonContinue}>
