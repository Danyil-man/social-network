...
const PostModal: FC<PropsPostsModal> = ({ postAva, username, postImg }) => {
                        ...
                        <div className={postModal.interaction}>
                            <div className={postModal.header}>
                                ...
                                <div className={postModal.CloseBtn}>
                                    <button className={postModal.titleCloseBtn} onClick={() => setIsModal(false)}> <i className="far fa-times-circle"></i> </button>
                                </div>
                            </div>
                            ...
                            <div className={postModal.commentsBlock}>
                                ...
                                <div className={postModal.commentfooter}>
                                    <div className={postModal.commentLikes}>
                                        likes
                                    </div>
                                    <div className={postModal.comment__input}>
