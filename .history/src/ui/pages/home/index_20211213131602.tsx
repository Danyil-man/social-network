...
const IdxHome: FC<ContainerHomeType> = ({ isAuth, profile, isLoading, users, editProfile, getUsers, getProfileUser }) => {
    console.log(getProfileUser)
    let OwnerUsername = profile?.username
    alert(OwnerUsername)
    if (!OwnerUsername) {
        OwnerUsername = 'danyil'
    }
