...
import { getAllPosts, likePost, removelikePost } from 'core/store/reducers/postsReducer';
...
export default connect(mapStateToProps, { editProfile, getUsers, getProfile, getProfileUser, getAllPosts, likePost, removelikePost })(IdxHome);
