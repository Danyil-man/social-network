...
import { AccountType, CreatePostType, GetAccountType, GetAllComments, GetAllPostsType, GetSinglePostType, ImagePhotoType } from 'core/store/api/api';
