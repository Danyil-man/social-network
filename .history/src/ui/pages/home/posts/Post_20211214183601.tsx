...
const Post: FC<PostType> = ({ user, posts, isLoading, getProfileUser, editProfile }) => {
    ...
    console.log('PostItem', postsItem)
    ...
    return (
        <div className={style.postItem}>
            <div className={style.header}>
                <div className={style.leftHeader}>
                    ...
                    <div className={style.content_info}>
                        ...
                        <p className={style.status}>{postsItem.created_at}</p>
                    </div>
                </div>
            ...
            <div className={style.text}>
                <p>{postsItem.description !== null ? postsItem.description : 'Post Without Descriptin' && style.italian}</p>
            </div>
