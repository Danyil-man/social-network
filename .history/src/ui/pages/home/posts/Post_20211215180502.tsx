...
const Post: FC<PostType> = ({ post, isLoading,
    ...
    const [likeCheck, setLikeChecker] = useState(false)
            ...
            <div className={style.interaction}>
                <div className={style.leftInteracion}>
                    <div className={style.likes}>
                        {post.is_liked ? (
                            <i onClick={() => removelikePost(post.id)} className={`${style.likeStyle}`}></i>
                        ) : (
                            <i onClick={() => likePost(post.id)} className={`${style.likeStyle}`}></i>
                        )}
