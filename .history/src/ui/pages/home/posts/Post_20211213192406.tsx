...
const Post: FC<PostType> = ({ user, posts, isLoading, key, getProfileUser, editProfile }) => {
    ...
    return (
        <div key={key} className={style.postItem}>
            ...
            <div className={style.mainImg}>
                {posts.map(post => <img key={key} width={560} onClick={() => setIsModal(true)} alt="post" />)}
