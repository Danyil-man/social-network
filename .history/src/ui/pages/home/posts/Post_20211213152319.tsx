...
const Post: FC<PostType> = ({ user, posts, profile, isLoading, getProfileUser, editProfile }) => {
    ...
    return (
        <div className={style.postItem}>
            ...
            <div className={style.mainImg}>
                {posts.map(post => <img src={post.created_at} width={560} onClick={() => setIsModal(true)} alt="post" />)}
            </div>
