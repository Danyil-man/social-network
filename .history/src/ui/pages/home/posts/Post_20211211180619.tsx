...
interface PostType {
    ...
    getProfileUser: (username: string) => any
}
        ...
        <div className={style.postItem}>
            <div className={style.header}>
                <div className={style.leftHeader}>
                    <button onClick={() => getProfileUser}>Take User</button>
                    <img onClick={() => setOpenProfile(true)} width={40} src={user.profile_photo_url != null ? user.profile_photo_url : UserPhoto} alt="postHeader" />
