...
const Post: FC<PostType> = ({ userItem, isLoading, getProfileUser, editProfile }) => {
        ...
        <div className={style.postItem}>
            <div className={style.header}>
                <div className={style.leftHeader}>
                    <Link to={`/profile`}>
                        <img onClick={TakeUser} width={40} src={userItem.profile_photo_url !== null ? user.profile_photo_url : UserPhoto} alt="postHeader" />
                    </Link>
